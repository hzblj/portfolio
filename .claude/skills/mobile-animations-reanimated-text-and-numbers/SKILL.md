...
For a title that reveals letter by letter, split into characters and stagger built-in `entering` layout animations by index — no shared values needed. See [layout-animations](../mobile-animations-reanimated-layout-animations/SKILL.md).
