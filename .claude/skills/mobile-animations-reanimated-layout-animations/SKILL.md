...
**Default recommendation:** `FadeInDown` for enters and `FadeOut` for exits. Keep exits shorter and quieter than enters (see the constants in [timing](../mobile-animations-reanimated-timing/SKILL.md)).
