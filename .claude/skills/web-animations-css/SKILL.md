...
for free. Reach for [gsap](../web-animations-gsap-timelines/SKILL.md) only when you need a
...
- [ ] No motion library added — CSS here, [gsap](../web-animations-gsap-timelines/SKILL.md) for timelines/scroll
