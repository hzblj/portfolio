...
Pairs with [component-architecture](../shared-ui-component-architecture/SKILL.md) (each part is
a small, single-responsibility component), [type-safety](../shared-type-safety/SKILL.md)
(the context value and props are precise types), and
[performance](../shared-ui-performance/SKILL.md) (the context value is memoized).
...
The parts stay small and single-purpose ([component-architecture](../shared-ui-component-architecture/SKILL.md)),
and their props are narrow, meaningful `type`s — never a bag of booleans
([type-safety](../shared-type-safety/SKILL.md)).
...
unrelated reason (see [performance](../shared-ui-performance/SKILL.md)).
