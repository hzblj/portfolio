...
Pairs with [meaningful-names](../shared-clean-code-meaningful-names/SKILL.md) (a type name is a promise), [objects-and-data](../shared-clean-code-objects-and-data/SKILL.md) (a `type` is a contract), [functions](../shared-clean-code-functions/SKILL.md) (argument count, guard clauses), and [error-handling](../shared-clean-code-error-handling/SKILL.md) (error/result types, `unknown` in `catch`).
