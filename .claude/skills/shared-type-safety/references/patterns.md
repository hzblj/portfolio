...
Code examples for every rule in [`SKILL.md`](../../shared-type-safety/SKILL.md). Each section is a `// Bad`
...
handlers, tokenizers, tight loops. See [functions](../../shared-clean-code-functions/SKILL.md)
