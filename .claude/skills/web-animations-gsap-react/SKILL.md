...
See [timelines](../web-animations-gsap-timelines/SKILL.md) for building timelines inside the callback, [scroll-trigger](../web-animations-gsap-scroll-trigger/SKILL.md) for scroll cleanup, and [performance](../web-animations-gsap-performance/SKILL.md) for reduced motion.
