...
See [scroll-trigger](../web-animations-gsap-scroll-trigger/SKILL.md) to drive a timeline from scroll, [react](../web-animations-gsap-react/SKILL.md) for building timelines inside `useGSAP`, and [performance](../web-animations-gsap-performance/SKILL.md) for which properties are cheap to tween.
