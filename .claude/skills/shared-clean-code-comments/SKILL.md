...
This file is about the comments that earn their place and the ones that rot. For the naming and extraction techniques that dissolve most comments before they're written, see [meaningful-names](../shared-clean-code-meaningful-names/SKILL.md) and [functions](../shared-clean-code-functions/SKILL.md).
...
| Comment explaining *what* the code does | Rename / extract so the code explains itself ([meaningful-names](../shared-clean-code-meaningful-names/SKILL.md), [functions](../shared-clean-code-functions/SKILL.md)) |
