...
For what goes *inside* the functions you're ordering, see [functions](../shared-clean-code-functions/SKILL.md); for the names that make the layout legible, [meaningful-names](../shared-clean-code-meaningful-names/SKILL.md).
